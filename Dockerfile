...
RUN build_exts_dir.sh -v $GEOSERVER_VERSION -f /etc/geoserver_extensions -t /var/local/geoserver-exts
RUN cp /var/local/geoserver-exts/*/*.jar /usr/local/geoserver/WEB-INF/lib
